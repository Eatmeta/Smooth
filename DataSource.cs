...
namespace yield
{
	public class DataSource
	{
		public static IEnumerable<DataPoint> GetData(Random random)
		{
			...
			//return dataAnalyzer.MovingMax(dataAnalyzer.MovingAverage(dataAnalyzer.SmoothExponentially(GenerateOriginalData(random), 0.2), 20),150);
			return GenerateOriginalData(random).SmoothExponentially(0.2).MovingAverage(20).MovingMax(150);
		}
