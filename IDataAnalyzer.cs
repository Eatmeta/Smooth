...
namespace yield
{
	...
	{
		IEnumerable<DataPoint> SmoothExponentially(IEnumerable<DataPoint> data, double alpha);
	...
	{
		public IEnumerable<DataPoint> SmoothExponentially(IEnumerable<DataPoint> data, double alpha)
		{
			return data.SmoothExponentially(alpha);
		}
